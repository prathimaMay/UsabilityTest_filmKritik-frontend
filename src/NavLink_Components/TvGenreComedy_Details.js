...
const TvGenreComedy_Details = ({ id, name, poster_path, overview, vote_average, original_language, release_date, movie_id, new_rating }) => ( 
...
export default TvGenreComedy_Details;